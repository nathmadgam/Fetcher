...
local function buildConfiguration(configurationFolder)
	return {
		...
		ProfileInclude = {
			basics = readBoolean(configurationFolder, "ProfileInclude", "Basics", true),
			counts = readBoolean(configurationFolder, "ProfileInclude", "Counts", true),
			images = readBoolean(configurationFolder, "ProfileInclude", "Images", true),
			presence = readBoolean(configurationFolder, "ProfileInclude", "Presence", true),
			groups = readBoolean(configurationFolder, "ProfileInclude", "Groups", true),
			badges = readBoolean(configurationFolder, "ProfileInclude", "Badges", true),
			usernameHistory = readBoolean(configurationFolder, "ProfileInclude", "UsernameHistory", true),
			friendsPreview = readBoolean(configurationFolder, "ProfileInclude", "FriendsPreview", true),
			followersPreview = readBoolean(configurationFolder, "ProfileInclude", "FollowersPreview", true),
			followingsPreview = readBoolean(configurationFolder, "ProfileInclude", "FollowingsPreview", true),
			ownedGames = readBoolean(configurationFolder, "ProfileInclude", "OwnedGames", true),
			bloxlink = readBoolean(configurationFolder, "ProfileInclude", "Bloxlink", true),
		},
		Names = {
			...
			ProfilesFolderName = readString(configurationFolder, "Names", "ProfilesFolderName", "Profiles"),
		},
